...
it('accepts valid filter params and returns success response', function (): void {
    ...
    $response = $this->getJson('/api/v1/courses/filter?category_id=2&status=1&level_id='.$level->id.'&price_min=100&price_max=300&rating_min=3.5&rating_max=4.5&learned_min=10&learned_max=20&q=basic&page=1&perPage=15');
...
it('returns validation error when level id is invalid', function (): void {
